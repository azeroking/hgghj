...
def create():
 ...
 if '"comment":"Exists"' in str(decoded_data):
  ...
  created+=1
  y = requests.post(f"https://api.telegram.org/bot{7247904695:AAHM1bI_ha9_XEdzyejR5UjxnhbqBXS7nY0}/sendmessage?chat_id={6841385539}&text="+str(tlg))
